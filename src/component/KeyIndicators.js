    ...
    return (
        <div className='p-24'>
            ...
            <div className="grid grid-cols-4 gap-9 pt-10">
                <div className='bg-orange-200 p-12 rounded-lg'>
                ...
                <div className='bg-blue-200 p-12 rounded-lg'>
                    ...
                    <p className='text-base'>Stage 1 Verification Completed: Gram Panchayat or ULB Level.</p>
                </div>
                <div className='bg-yellow-200 p-12 rounded-lg'>
                    {/* logo */}
                    <ContentPasteIcon className='' />
                    <h2 className='text-3xl font-bold'>4,31,350</h2>
                    <p className='text-base'>Stage 2 Verification Completed: District Implementation Committee</p>
                </div>
                <div className='bg-red-200 p-12 rounded-lg'>
                    {/* logo */}
                    <ContentPasteIcon className='' />
                    <h2 className='text-3xl font-bold'>2,01,503</h2>
                    <p className='text-base'>Stage 3 Verification Completed: Screening Committee</p>
                </div>
